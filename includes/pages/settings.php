...
<div id="poststuff" class="wrap">
    ...
    <?php endif; ?>
    <div class="right">
        <?php require_once dirname(__FILE__) . '/../boxes.php' ?>
    </div>
    <div class="left">
    ...
    <div class="inside">
    <?php echo _e('To fully leverage Cleeng you need to understand the different "settings":','cleeng') ?>     <br/><br/>

    <?php echo _e('<b>Publisher settings - </b>like your publisher name, your currency and pay-out details. First you need to <a class="publisher-account" href="'.$cleeng->getUrl().'/publisher-registration/popup/1">create a publisher
    ...
    <?php echo _e('<b>Protection / sell per item settings - </b>like price, description and referral rate. Within WordPress you can define this on the
    ...
    <?php echo _e('<b>Daily pass & Subscriptions - </b>Once you have protected multiple items, you can consider to set up subscriptions. You can
    ...
    <?php echo _e('<b>Cleeng settings for WordPress - </b>a few additional settings that are specific to the plugin you are using. You can find them
