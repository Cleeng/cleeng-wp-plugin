        ...
        <div class="cleeng-text-bottom">
            <div class="cleeng-textBottom">
                ...
                <div class="cleeng-whatsCleeng" style="width:171px">
                     <div style="cursor:pointer;width:150px;line-height:12px;background: url('<?php echo $cleeng->getLogoUrl( $contentId, 'cleeng-small' )?>') no-repeat right top" href="<?php echo $cleeng->getUrl() ?>/what-is-cleeng">Powered by</div>    
